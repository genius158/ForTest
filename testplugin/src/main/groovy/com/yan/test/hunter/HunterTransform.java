...
import com.yan.test.hunter.asm.ClassLoaderHelper;
import java.io.File;
...
public class HunterTransform extends Transform {
  ...
  @Override public void transform(TransformInvocation transformInvocation)
      throws TransformException, InterruptedException, IOException {
    innerTransform(transformInvocation.getContext(), transformInvocation.getInputs(),
        transformInvocation.getReferencedInputs(), transformInvocation.getOutputProvider(),
        transformInvocation.isIncremental());
  }

  private void innerTransform(Context context, Collection<TransformInput> inputs,
    ...
    URLClassLoader urlClassLoader =
        ClassLoaderHelper.getClassLoader(inputs, referencedInputs, project);
